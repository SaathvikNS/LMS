...
const ProfileMain = ({navigation}) => {
    const {module, empname, empmail, empempid, empcontact, empdoj, empdob, empgender, } = useContext(MyContext);
  return (
    <View style={styles.container}>
        ...
        <View style={styles.contentwrapper}>
            ...
            <ProfileInfoBlocks source={require("../../../assets/profileicons/email.png")} keyplace={"E mail"} valueplace={empmail || "-"}/>
            <ProfileInfoBlocks source={require("../../../assets/profileicons/contact.png")} keyplace={"Contact"} valueplace={empcontact || "-"}/>
            <ProfileInfoBlocks source={require("../../../assets/profileicons/doj.png")} keyplace={"Date of Joining"} valueplace={empdoj || "-"}/>
            <ProfileInfoBlocks source={require("../../../assets/profileicons/dob.png")} keyplace={"Date of Birth"} valueplace={empdob || "-"}/>
            <ProfileInfoBlocks source={require("../../../assets/profileicons/gender.png")} keyplace={"Gender"} valueplace={empgender || "-"}/>
        </View>
